...
namespace Mapbox
{
    ...
    interface MGLShapeCollectionFeature : MGLFeature
    {
        ...
        [Static]
        [Export("shapeCollectionWithShapes:")]
        MGLShapeCollectionFeature ShapeCollectionWithShapes(IMGLFeature[] shapes);
    }
    ...
    interface MGLMapCamera : INSSecureCoding, INSCopying
    {
        ...
        MGLMapCamera CameraLookingAtCenterCoordinateFromEyeCoordinate(CLLocationCoordinate2D centerCoordinate, CLLocationCoordinate2D eyeCoordinate, double eyeAltitude);
        ...
        MGLMapCamera CameraLookingAtCenterCoordinateAltitude(CLLocationCoordinate2D centerCoordinate, double altitude, nfloat pitch, double heading);
    ...
    interface MGLMapView
    {
        ...
        MGLMapViewDecelerationRate DecelerationRate { get; set; }
        ...
        void SelectAnnotation(MGLAnnotation annotation, bool animated, [NullAllowed] Action completion);
        ...
        void SelectAnnotation(MGLAnnotation annotation, bool moveIntoView, bool animateSelection, [NullAllowed] Action completion);
    ...
    interface MGLMapViewDelegate
    {
        ...
        bool MapViewShouldChangeFromCamera(MGLMapView mapView, MGLMapCamera oldCamera, MGLMapCamera newCamera);
        ...
        bool MapViewShouldChangeFromCamera(MGLMapView mapView, MGLMapCamera oldCamera, MGLMapCamera newCamera, MGLCameraChangeReason reason);
        ...
        void MapViewRegionWillChangeAnimated(MGLMapView mapView, bool animated);
        ...
        void MapViewRegionDidChangeAnimated(MGLMapView mapView, bool animated);
        ...
        [return: NullAllowed]
        UIImage MapViewDidFinishLoadingStyle(MGLMapView mapView, string imageName);
        ...
        [return: NullAllowed]
        MGLAnnotationImage MapViewImageForAnnotation(MGLMapView mapView, IMGLAnnotation annotation);
        ...
        nfloat MapViewAlphaForShapeAnnotation(MGLMapView mapView, MGLShape annotation);
        ...
        UIColor MapViewStrokeColorForShapeAnnotation(MGLMapView mapView, MGLShape annotation);
        ...
        UIColor MapViewFillColorForPolygonAnnotation(MGLMapView mapView, MGLPolygon annotation);
        ...
        nfloat MapViewLineWidthForPolylineAnnotation(MGLMapView mapView, MGLPolyline annotation);
        ...
        [return: NullAllowed]
        MGLAnnotationView MapViewViewForAnnotation(MGLMapView mapView, IMGLAnnotation annotation);
        ...
        bool MapViewAnnotationCanShowCallout(MGLMapView mapView, IMGLAnnotation annotation);
        ...
        [return: NullAllowed]
        MGLCalloutView MapViewCalloutViewForAnnotation(MGLMapView mapView, IMGLAnnotation annotation);
        ...
        [return: NullAllowed]
        UIView MapViewLeftCalloutAccessoryViewForAnnotation(MGLMapView mapView, IMGLAnnotation annotation);
        ...
        [return: NullAllowed]
        UIView MapViewRightCalloutAccessoryViewForAnnotation(MGLMapView mapView, IMGLAnnotation annotation);
        ...
        void MapViewAnnotation(MGLMapView mapView, IMGLAnnotation annotation, UIControl control);
        ...
        void MapViewTapOnCalloutForAnnotation(MGLMapView mapView, IMGLAnnotation annotation);
    }
    ...
    [Static]
    interface MGLOfflinePackUserInfoKeys
    {
        ...
        NSString MaximumCountKey { get; }
    }
    
    [StrongDictionary("MGLOfflinePackUserInfoKeys")]
    interface MGLOfflinePackUserInfo
    {
        long State { get; set; }

        NSValue Progress { get; set; }

        NSError Error { get; set; }

        long MaximumCount { get; set; }
    }
    ...
    interface MGLStyle
    {
        ...
        void InsertLayerAtIndex(MGLStyleLayer layer, nuint index);
    ...
    interface MGLSymbolStyleLayer
    {
        ...
        // @property (nonatomic) NSExpression * _Null_unspecified symbolSortKey;
        [Export("symbolSortKey", ArgumentSemantic.Assign)]
        ...
        // @property (nonatomic) NSExpression * _Null_unspecified textRadialOffset;
        [Export("textRadialOffset", ArgumentSemantic.Assign)]
        ...
        // @property (nonatomic) NSExpression * _Null_unspecified textVariableAnchor;
        [Export("textVariableAnchor", ArgumentSemantic.Assign)]
    ...
    interface MGLShapeSource
    {
        ...
        IntPtr Constructor(string identifier, IMGLFeature[] features, [NullAllowed] NSDictionary<NSString, NSObject> options);
    ...
    interface MGLComputedShapeSource
    {
        ...
        [DesignatedInitializer]
        IntPtr Constructor(string identifier, [NullAllowed] NSDictionary options);
        ...
        IntPtr Constructor(string identifier, MGLComputedShapeSourceDataSource dataSource, [NullAllowed] NSDictionary options);
    ...
    //[BaseType(typeof(NSObject))]
    //partial interface NSExpression_Ext
    //{
    ...
    //    NSExpression Mgl_expressionForInterpolatingExpression(NSExpression inputExpression, MGLExpressionInterpolationMode curveType, [NullAllowed] NSExpression parameters, NSExpression stops);
    ...
    //    NSExpression Mgl_expressionForMatchingExpression(NSExpression inputExpression, NSDictionary matchedExpressions, NSExpression defaultExpression);

    //    // +(instancetype _Nonnull)mgl_expressionForAttributedExpressions:(NSArray<NSExpression *> * _Nonnull)attributedExpressions;
    //    [Static]
    ...
    interface MGLNetworkConfiguration
    {
        ...
        // @property (atomic, strong) NSURLSessionConfiguration * _Null_unspecified sessionConfiguration;
        [Export("sessionConfiguration", ArgumentSemantic.Strong)]
    ...
    //partial interface Constants
    //{
    //    // extern const MGLAttributedExpressionKey _Nonnull MGLFontNamesAttribute __attribute__((visibility("default")));
    //    [Field("MGLFontNamesAttribute", "__Internal")]
    //    NSString MGLFontNamesAttribute { get; }

    //    // extern const MGLAttributedExpressionKey _Nonnull MGLFontScaleAttribute __attribute__((visibility("default")));
    //    [Field("MGLFontScaleAttribute", "__Internal")]
    //    NSString MGLFontScaleAttribute { get; }

    //    // extern const MGLAttributedExpressionKey _Nonnull MGLFontColorAttribute __attribute__((visibility("default")));
    //    [Field("MGLFontColorAttribute", "__Internal")]
    //    NSString MGLFontColorAttribute { get; }
    //}
    ...
    interface MGLAttributedExpression
    {
        ...
        MGLAttributedExpression AttributedExpression(NSExpression expression, NSDictionary attrs);
    }
